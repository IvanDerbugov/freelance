...
export function Screen4() {
  ...
  return (
    <div className="w-full flex items-center justify-center bg-[#bb00ff] px-4 md:px-8 px-8-400 py-12 md:py-16 py-65-mobile relative overflow-hidden" style={{ minHeight: '100vh' }}>
      {/* Noise Texture */}
      <NoiseTexture />
