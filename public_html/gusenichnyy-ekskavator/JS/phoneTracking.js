    ...
    function sendYandexMetricGoal(goalName, description) {
        try {
            if (typeof ym === 'function') {
                ym(103422283, 'reachGoal', goalName);
    ...
    function addEventListeners() {
        ...
        phoneLinks.forEach(function(link) {
            ...
            if (!link.hasAttribute('data-phone-tracked')) {
                ...
                link.addEventListener('click', function(e) {
                    handleLinkClick(e, 'telGusenichnyexkavator', 'Клик по телефону');
                });
            }
        });
        ...
        whatsappLinks.forEach(function(link) {
            ...
            if (!link.hasAttribute('data-whatsapp-tracked')) {
                ...
                link.addEventListener('click', function(e) {
                    handleLinkClick(e, 'WhatsAppGusenichnyexkavator', 'Клик по WhatsApp');
                });
            }
        });
