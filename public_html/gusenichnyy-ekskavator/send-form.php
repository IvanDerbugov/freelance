...
$formType = isset($input['form_type']) ? htmlspecialchars(trim($input['form_type'])) : 'Гусеничный экскаватор';
...
$subject = "Новая заявка с сайта ГУСЕНИЧНЫЙ ЭКСКАВАТОР - $formType";
...
<body>
    <h2>Новая заявка с сайта ГУСЕНИЧНЫЙ ЭКСКАВАТОР</h2>
...
$telegramMessage = "🚨 *НОВАЯ ЗАЯВКА С САЙТА ГУСЕНИЧНЫЙ ЭКСКАВАТОР*
