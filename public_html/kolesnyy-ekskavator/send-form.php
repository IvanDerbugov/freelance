...
$formType = isset($input['form_type']) ? htmlspecialchars(trim($input['form_type'])) : 'Колесный экскаватор';
...
$subject = "Новая заявка с сайта КОЛЕСНЫЙ ЭКСКАВАТОР - $formType";
...
<body>
    <h2>Новая заявка с сайта КОЛЕСНЫЙ ЭКСКАВАТОР</h2>
...
$telegramMessage = "🚨 *НОВАЯ ЗАЯВКА С САЙТА КОЛЕСНЫЙ ЭКСКАВАТОР*
