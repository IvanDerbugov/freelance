document.addEventListener('DOMContentLoaded', function() {
    ...
    function showContactModal() {
        ...
        contactModalWindow.innerHTML = `
            ...
            <form class="modal-form" id="formaKolesnyyexkavator">
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    if (typeof ym === 'function') {
                        ym(103422304, 'reachGoal', 'formaKolesnyyexkavator');
                        console.log('Цель "Отправка формы из модального окна" отправлена в Яндекс Метрику (formaKolesnyyexkavator)');
                    }
