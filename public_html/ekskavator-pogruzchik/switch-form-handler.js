// Скрипт для переключения между web3forms и PHP обработчиком
...
if (mode === 'web3forms') {
    ...
    // Создаем web3forms версию
    const web3formsContent = `// modal.js - WEB3FORMS ВЕРСИЯ
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    modalWindow.innerHTML = \`
        ...
        <form class="modal-form" id="formaPogruzchik" action="https://api.web3forms.com/submit" method="POST">
            ...
            <input type="hidden" name="subject" value="Новая заявка с сайта ЭКСКАВАТОР-ПОГРУЗЧИК">
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(data => {
            ...
            // Проверяем успешность отправки web3forms
            if (data.success) {
    ...
    function showContactModal() {
        ...
        contactModalWindow.innerHTML = \`
            ...
            <form class="modal-form" method="POST" id="formaPogruzchik" action="https://api.web3forms.com/submit">
                <input type="hidden" name="access_key" value="d759a276-7f88-4a85-a572-a472510fd51b">
                <input type="text" name="name" placeholder="Ваше имя" required autocomplete="name">
                <input type="text" name="contact" placeholder="Телефон или e-mail" required autocomplete="tel">
                <input type="hidden" name="form_type" value="pogruzchik">
                <input type="hidden" name="subject" value="Новая заявка с сайта ЭКСКАВАТОР-ПОГРУЗЧИК (см. больше)">
        ...
        // Навешиваем обработчики на новые ссылки (телефон/WhatsApp)
        if (window.phoneTrackingAddListeners) window.phoneTrackingAddListeners();
