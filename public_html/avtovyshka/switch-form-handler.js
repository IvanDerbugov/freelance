// Скрипт для переключения между web3forms и PHP обработчиком - АВТОВЫШКА
...
if (mode === 'web3forms') {
    ...
    const web3formsContent = `// modal.js - WEB3FORMS ВЕРСИЯ - АВТОВЫШКА
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    modalWindow.innerHTML = \`
        ...
        <form class="modal-form" id="formaAvtovyschky" action="https://api.web3forms.com/submit" method="POST">
            ...
            <input type="hidden" name="subject" value="Новая заявка с сайта АВТОВЫШКА">
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                if (typeof ym === 'function') {
                    ym(103422272, 'reachGoal', 'formaAvtovyschky');
    ...
    function showContactModal() {
        ...
        contactModalWindow.innerHTML = \`
            ...
            <form class="modal-form" id="formaAvtovyschky" action="https://api.web3forms.com/submit" method="POST">
                ...
                <input type="text" name="name" placeholder="Ваше имя" required autocomplete="name">
                <input type="text" name="contact" placeholder="Телефон или e-mail" required autocomplete="tel">
                <input type="hidden" name="subject" value="Новая заявка с сайта АВТОВЫШКА (см. больше)">
