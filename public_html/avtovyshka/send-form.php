...
$formType = isset($input['form_type']) ? htmlspecialchars(trim($input['form_type'])) : 'Автовышка';
...
$subject = "Новая заявка с сайта АВТОВЫШКА - $formType";
...
<body>
    <h2>Новая заявка с сайта АВТОВЫШКА</h2>
...
$telegramMessage = "🚨 *НОВАЯ ЗАЯВКА С САЙТА АВТОВЫШКА*
